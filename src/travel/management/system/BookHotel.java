...
public class BookHotel extends JFrame implements ActionListener {
  ...
  BookHotel(String username) {
    ...
    JLabel lblac = new JLabel("Room - AC / Non-AC");
  ...
  public void actionPerformed(ActionEvent ae) {
    if (ae.getSource() == checkprice) {
      try {
        ...
        while (rs.next()) {
          ...
          if (person * days > 0) {
            ...
            JOptionPane.showMessageDialog(null, "Please enterr a valid number");
          }
        }
      } catch (Exception e) {
        e.printStackTrace();
      ...
      try {
        Conn c = new Conn();
        String query = "insert into bookhotel values('" + labelusername.getText() + "','" + chotel.getSelectedItem() + "','" + tfperson.getText()
            + "','" + tfdays.getText() + "','" + cac.getSelectedItem() + "','" + cfood.getSelectedItem() + "','" + labelid.getText() + "','"
